...
base = [123, 32, 18, 98, 119, 108, 65, 41, 124, 80, 125, 38, 124, 111, 74, 49, 83, 108, 94,
...
var = [18, 64, 98, 5, 2, 4, 6, 3, 6, 48, 49, 65, 32, 12, 48, 65, 31, 78, 62, 32, 49, 32,
...
_len = len(base)
for i in range(_len):
    result.append(chr(0x13 ^ (base[i] ^ var[i])))
print(''.join(result))
